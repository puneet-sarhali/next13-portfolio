...
export default function featuredProject() {
  return (
    <>
      <div className="flex flex-col relative text-neutral-500 border border-neutral-900 bg-neutral-950 hover:bg-neutral-900 transition-all duration-500 w-full h-full p-6 rounded-lg pr-16">
        ...
        <div className="mt-4">
          <h3 className="text-xs">Visitors this month</h3>
